                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="container">
                                        ...
                                        <form method="post" action="{{ url('simpan-karyawan') }}">
                                            {{ csrf_field() }}
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input style="text-transform: capitalize;" type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama" required>
                                            </div>
                                            <div class="mb-3">
